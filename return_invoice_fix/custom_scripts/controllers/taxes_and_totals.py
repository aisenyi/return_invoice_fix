...
class custom_calculate_taxes_and_totals(calculate_taxes_and_totals):
	def set_total_amount_to_default_mop(self, total_amount_to_pay):
		...
		# Customization: If it's a return invoice, set the paid amount equal to the grand total to fix
		# "Paid amount + Write Off Amount can not be greater than Grand Total" bug
